...
<head>
    ...
    <link rel="stylesheet" type='text/css' href="manage5.css">
...
<body>
    ...
    <div class="main">
        <?php
            ...
            $db = mysqli_select_db($conn,'result_portal');

            $sql = "SELECT `id`, `dept` FROM `department`";
            $result = mysqli_query($conn, $sql);

            if (mysqli_num_rows($result) > 0) {
               echo "<fieldset><table>
                <legend style=font-size:40px>Manage Department</legend>
                <tr>
                <th>SNO</th>
                <th>NAME</th>
                <th>ACTION</th>
